...
class DataStageMetadata:
    ...
    consumed_samples_per_tokenizer: Dict[str, int] = dataclasses.field(default_factory=dict)
    consumed_tokens_per_tokenizer: Dict[str, int] = dataclasses.field(default_factory=dict)
    active_steps_per_tokenizer: Dict[str, int] = dataclasses.field(default_factory=dict)
