...
# Train the single_small baseline described in docs/single_small_baseline.md.
# Optional overrides:
...
config_file="$script_dir/config_dclm_stack_20m_single_small_10b_seq4096_seed1000.yaml"
log_file="${LOG_FILE:-$script_dir/train_dclm_stack_20m_single_small.log}"
